...
public class UIMenu {
    ...
    private static void authUser(int userType) throws ParseException {
        ...
        doctors.add(new Doctor("anahi llanes", "anahiL@gmail.com"));
        doctors.add(new Doctor("cesar chedar", "ChedarC@gmail.com"));

        ArrayList<Patient> patients = new ArrayList<>();
        patients.add(new Patient("shiro", "shirito@gmail.com"));
        patients.add(new Patient("coco", "coconut@gmail.com"));
        patients.add(new Patient("queen", "queenthefox@gmail.com"));

        boolean emailCorrect = false;
        do {
            System.out.println("Inserte su correo [@.com]");
            Scanner sc = new Scanner(System.in);
